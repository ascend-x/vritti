              ...
              : paged.length === 0
                ...
                : paged.map((row, i) => (
                  <tr
                    ...
                    className={`transition-colors duration-75 ${onRowClick ? 'cursor-pointer hover:bg-slate-50' : ''}
                      ${i % 2 === 1 ? 'bg-slate-50/50' : 'bg-white'}`}
                  >
                    {columns.map(col => (
                      <td key={col.key} className="px-4 py-3 text-slate-800 whitespace-nowrap">
